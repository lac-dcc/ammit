 ...
 * counts how many distinct values appear a number of times divisible by 4,
 ...
 *
 * Example usage:
 *     $ ./count_freq_div4 2 2 2 2 3 3 3 3 3 5
 *     The test passed
 *
 * Notes:
...
int main(int argc, char *argv[]) {
    ...
    // Count values with frequency divisible by 4
    int count_div4 = 0;
    ...
    result = count_div4; // Store the computation result
